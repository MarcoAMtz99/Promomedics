<?php 
  ...
  if(!array_key_exists(MOD_ESPECIALIDAD, $perm['children'])){
    ...
    $perm = $perm['children'][MOD_ESPECIALIDAD];
    $perm = $perm['action'];
  }
...
?>
                  ...
                  <form class="form-horizontal form-label-left">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" id="item-nom" required="required" class="form-control col-md-7 col-xs-12" placeholder="Nombre de la especialidad">
                      </div>
                    </div>
                    <!--div class="form-group">
          ...
          <div class="modal fade" id="frm-item-del" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <p>¿Estas seguro de eliminar la especialidad '<strong></strong>'?</p>
    ...
    <script>
      $(document).ready(function() {
        ...
        $('#btnSave').click(function() {
          ...
          if(data.nom.length < 3){
            ...
            act = 'addEspecialidad';
            if(parseInt(data.id,10) > 0) act = 'editEspecialidad';
            NProgress.start();
        ...
        $('#btnDelete').click(function() {
            ...
            $.post(
                '/core/precargas.php',
                {action: 'delEspecialidad', nom: nom, id: id},
                function(resp){
                  if(resp.res){
                    $('#tbl-items').DataTable().destroy();
                    trp.remove();
      ...
      function addItemRow(item, act){
        ...
        tr.append('<td data-id="'+item.ID+'" class="text-center">'+act+'</td>');
